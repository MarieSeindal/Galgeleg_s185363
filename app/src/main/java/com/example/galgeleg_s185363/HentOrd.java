...
public class HentOrd {
    ...
    // Henter ord fra regne ark og starter spil
    /**
     ...
     * @throws Exception
     */
    public static void hentOrdFraRegneark(String sværhedsgrader, ArrayList<String> muligeOrd) throws Exception {
     ...
     */
    public static void hentOrdFraDr(ArrayList<String> muligeOrd) throws Exception {
